 ...
 */
function clean_theme_customize_preview_js() {
	wp_enqueue_script( 'clean-theme-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
add_action( 'customize_preview_init', 'clean_theme_customize_preview_js' );
